...
export NETWORK=Analog Blockchain Explorer
export SUBNETWORK="Rabbit Testnet :"
export LOGO=/images/analogscan_logo.svg
export LOGO_FOOTER=/images/analogscan_logo.svg
...
export RE_CAPTCHA_SECRET_KEY=6Lfh-e8hAAAAABPP7qUKRHmxc1C8Uo88EkvTwspI
export RE_CAPTCHA_CLIENT_KEY=6Lfh-e8hAAAAAI0WBminlGLWfxOLZOOtrkKQhTGg
